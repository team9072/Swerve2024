...
public class RobotContainer {
    ...
    private void configureButtonBindings() {
        ...
        m_attachmentController.povLeft().onTrue(
                Commands.runOnce(() -> m_attatchment.setPivotPosition(PivotPosition.kSubwooferPosition,
                        PivotConstants.kSubwooferPos)));
        ...
        SmartDashboard.putNumber("Pivot Angle", 10);

        m_attachmentController.povRight().onTrue(Commands.runOnce(() -> m_attatchment
                .setPivotPosition(PivotPosition.kSpeakerPosition, SmartDashboard.getNumber("Pivot Angle", 10))));

        m_attachmentController.start().onTrue(
                Commands.runOnce(() -> m_attatchment.setPivotPosition(PivotPosition.kSubwooferSidePosition,
                        PivotConstants.kSubwooferSidePos)));
